...
Only for Centos, install Agent manually using the instructions. [Install Agent for Centos](https://docs.nginx.com/nginx-agent/installation-upgrade/installation-oss/#installing-nginx-agent-on-rhel-centos-rocky-linux-almalinux-and-oracle-linux)
