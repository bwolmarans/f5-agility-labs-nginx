...
.. code-block:: nginx
    ...
    #   * Official OSS Documentation: https://nginx.org/en/docs/
    #   * Official NGINX Plus Documentation: https://docs.nginx.com/
...
`Proceed to the Next Lesson <https://github.com/bwolmarans/f5-agility-labs-nginx/blob/develop/docs/class4/module2/2.2-change-conf.rst>`_
